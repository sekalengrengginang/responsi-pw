...
import WatermelonJSON from "/public/img/nut.json";
    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="img/deeznut.png" class="h-8 mr-3" alt=" Logo" />
            </a>
            <div class="flex md:order-2">
                <div v-if="canLogin">
                    <a v-if="$page.props.auth.user" :href="route('dashboard')"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Dashboard</a>
                    <template v-else>
            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                    <a href="#"
                        ...
                        Mulai Sekarang! <svg class="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
